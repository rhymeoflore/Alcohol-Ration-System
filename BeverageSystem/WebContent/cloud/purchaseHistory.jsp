...
<div class="wrapper col5">
  <div id="container">
    <div id="content">
      ...
      <form action="viewpurchasehistory.jsp" name="form1">
      ...
      <table>
      	<tr>
      		...
      		<td>
      			...
      			<%while(outlets.next()){ %>
      				<option value="<%=outlets.getString("id")%>"><%=outlets.getString("bevid") +outlets.getString("place") %></option>
      				<%} %>
      			</select>
      		
      		</td>
      		<td><input type="submit" value="VIEW" onclick="return validpurchasehistory()"></td>
