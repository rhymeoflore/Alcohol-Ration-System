...
<%@page import="in.inzenjer.BlowFish.DataEncryption"%>
...
<div class="wrapper col5">
  <div id="container">
    <div id="content">
      <% 
      String bevID=request.getParameter("bev");
      ResultSet outlets=AdminDAO.getAllOutLets();
      ArrayList<Transaction> list= AdminHistory.getPurchaseHistory(bevID); %>
