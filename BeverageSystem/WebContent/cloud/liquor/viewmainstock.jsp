			...
			<ul>
				...
				<li><a href="#">Liquor</a><span>Test Text Here</span>
					<ul>
					  ...
					  <li><a href="viewmainstock.jsp">View Stock</a></li>
	...
	<div class="wrapper col5">
		<div id="container">
			<div id="content">
				...
				<%
					int val = 1;
					ResultSet res = AdminDAO.getAllStockDeatils();
				...
				<table align="center" border="1" " width="600" background="red">
					...
					<tr>
						...
						<td><%=GetNamesByID.getLiquorTypeNameByID(res.getString(2))%></td>
