...
<%@page import="in.inzenjer.BlockChain.GetBlockChain"%>
  ...
  <div id="container">
    <div id="content">
     ...
     // String bevID=ub.getBevid();
      ...
      %>
      <h6><%=firstname %></h6>
        <%ResultSet user=OutletAdminDAO.getUSerDeatilsByUSerID(request.getParameter("userID")); %>
        <% ArrayList<Transaction> transactions= GetBlockChain.readBlockChain(request.getParameter("userID")); %>
       
       <table>
       <%if(user.next()){ %>
       	<tr>
       		<td>Firstname:</td><td><%=user.getString("firstname") %></td>
       	</tr>
       		<tr>
       		<td>Lastname:</td><td><%=user.getString("lastname") %></td>
       	</tr>
       		<tr>
       		<td>age:</td><td><%=user.getString("age") %></td>
       	</tr>
       		<tr>
       		<td>gender:</td><td><%=user.getString("gender") %></td>
       	</tr>
       		<tr>
       		<td>address:</td><td><%=user.getString("address") %></td>
       	</tr>
       		<tr>
       		<td>Phone:</td><td><%=user.getString("phone") %></td>
       	</tr>
       	<%} %>
       </table>
       <%
